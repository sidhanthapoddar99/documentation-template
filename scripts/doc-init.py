...
with proper distinction between sections (non-collapsible headers) and 
subsections (collapsible groups).
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Generate documentation structure from YAML configuration'
    )
