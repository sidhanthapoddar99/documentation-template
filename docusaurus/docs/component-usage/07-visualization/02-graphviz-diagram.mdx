...
The GraphViz component provides interactive viewing for DOT language graphs with pan/zoom capabilities and node selection features.

## Features

- 📊 **GraphViz DOT Language**: Full support for DOT syntax
- 🔍 **Interactive Canvas**: Pan and zoom controls like Mermaid diagrams
- 🎯 **Node Selection**: Click nodes to highlight connected elements
- 🌓 **Theme Aware**: Automatic color adaptation for light/dark modes
- 🖱️ **Full Interactivity**: Drag to pan, Ctrl+scroll to zoom
