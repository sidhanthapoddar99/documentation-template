...
<FileCollapsibleCodeBlock content={SwizzleCommands} filename="swizzle-commands.bash" description="Common swizzle commands for listing and overriding theme components" />
