...
<FileCollapsibleCodeBlock content={DevStartCode} filename="dev-start.bash" />
...
<FileCollapsibleCodeBlock content={ProductionBuildCode} filename="production-build.bash" />
...
<FileCollapsibleCodeBlock content={BuildOutputCode} filename="build-output-structure.txt" />
