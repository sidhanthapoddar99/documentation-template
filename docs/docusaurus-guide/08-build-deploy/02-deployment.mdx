...
<FileCollapsibleCodeBlock 
  content={GitHubPagesCode} 
  filename="github-pages-deploy.bash" 
  description="Commands to deploy Docusaurus site to GitHub Pages"
/>
...
<FileCollapsibleCodeBlock 
  ...
  description="Vercel configuration file for Docusaurus deployment"
/>
...
<FileCollapsibleCodeBlock 
  ...
  description="Netlify configuration file for build and deployment settings"
/>
